namespace Creatio.Copilot
{
	...
	internal class CopilotPromptFactory : ICopilotPromptFactory
	{
		...
		internal static readonly string[] ChatGlobalSettingsSectionPromptsForAgents = new[] {
			...
			"> ⚠️ You must **always select an Agent before responding**. Until any Agent or Skill is started, **do not answer user questions** unrelated to the tool descriptions. Instead, suggest available tools (in order of relevance) with **user-friendly descriptions** (not technical names).\n",
